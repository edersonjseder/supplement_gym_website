...
export const getSuggestedProducts = createAsyncThunk(
  ...
  async (_, thunkAPI) => {
    try {
      return await productService.getSuggestedProducts();
    } catch (error) {
      const message =
        (error.response &&
          error.response.data &&
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getProduct.fulfilled, (state, action) => {
        ...
        state.isSuccess = true;
        state.isError = false;
        console.log("Recipe_Slice: ", action.payload);
...
export const { CALC_VALUE, CALC_OUT_OF_STOCK, CALC_CATEGORY } =
  productSlice.actions;

export const selectIsLoading = (state) => state.products.isLoading;
export const selectProduct = (state) => state.products.product;
export const suggestedProducts = (state) => state.products.suggestedProducts;
export const selectTotalStoreValue = (state) => state.products.totalStoreValue;
export const selectOutOfStock = (state) => state.products.outOfStock;
