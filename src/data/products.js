...
import baunilha from "../images/baunilha.png";
...
const products = [
  {
    ...
    category: "sneakers",
    flavours: [
      { flavor: "Chocolate", icon: cacau },
      { flavor: "Vanilla", icon: baunilha },
      { flavor: "Natural", icon: folhas },
      { flavor: "Strawberry", icon: strawberry },
    ],
  },
  {
    id: "2",
  ...
  },
  {
    ...
    color: "white",
    category: "sandals",
    flavours: [{ flavor: "Strawberry", icon: "strawberry" }],
  },
  {
    id: "18",
    ...
    color: "blue",
    category: "sandals",
    flavours: [{ flavor: "Chocolate", icon: cacau }],
  },
  {
    id: "19",
    ...
    color: "black",
    category: "sandals",
    flavours: [{ flavor: "Vanilla", icon: "vanilla" }],
  },
  {
    id: "20",
